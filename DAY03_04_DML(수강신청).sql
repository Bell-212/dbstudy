...
CREATE TABLE STUDENT_TBL (
  ...
  , CONSTRAINT FK_PROF_STU FOREIGN KEY(PROF_NO) REFERENCES PROFESSOR_TBL(PROF_NO)
);
...
CREATE TABLE ENROLL_TBL (
  ...
  , CONSTRAINT FK_STU_ENR FOREIGN KEY(STU_NO) REFERENCES STUDENT_TBL(STU_NO)
  , CONSTRAINT FK_COUR_ENR FOREIGN KEY(COUR_NO) REFERENCES COURSE_TBL(COUR_NO)
);
...
CREATE TABLE LECTURE_TBL (
  ...
  , CONSTRAINT FK_PROF_LEC FOREIGN KEY(PROF_NO) REFERENCES PROFESSOR_TBL(PROF_NO)
  , CONSTRAINT FK_ENR_LEC FOREIGN KEY(ENR_NO) REFERENCES ENROLL_TBL(ENR_NO)
);
