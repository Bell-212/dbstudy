/*
    ...
    3. SELECT 절에서 조회하려는 칼럼 "반드시" GROUP BY 절에 명시되어 있어야 한다.
*/
...
-- 3. 사원 테이블에서 전화번호 앞 세자리가 같은 사원들을 그룹화 하여 각 그룹별로 연봉의 합계
...
SELECT DEPARTMENT_ID        
 ...
 GROUP BY DEPARTMENT_ID     --2)각 부서별
HAVING COUNT(*) >= 20;      --3)20명 이상인
